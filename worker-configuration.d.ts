...
declare namespace Cloudflare {
	...
	interface Env {
		...
		CodeGenObject: DurableObjectNamespace<import("./src/worker/index").CodeGeneratorAgent>;
		Sandbox: DurableObjectNamespace<import("./src/worker/index").UserAppSandboxService>;
		DORateLimitStore: DurableObjectNamespace<import("./src/worker/index").DORateLimitStore>;
		UserSecretsStore: DurableObjectNamespace<import("./src/worker/index").UserSecretsStore>;
