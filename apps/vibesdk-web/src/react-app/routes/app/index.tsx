...
export default function AppView() {
  ...
  const files = useMemo<FileType[]>(() => {
    ...
    return app.agentSummary.generatedCode
      .filter(
        (file) => file && file.filePath && typeof file.filePath === 'string',
      )
      .map((file) => ({
    ...
    (configKey: string) => {
      return async () => {
        ...
        try {
          ...
          toast.error(
            error instanceof ApiError ? error.message : config.errorMessage,
          );
        }
      };
    },
          ...
          <CardContent className="pt-6">
            <div className="text-center">
              ...
              <p className="text-text-tertiary mb-4">
                {error || "The app you're looking for doesn't exist."}
              </p>
                      ...
                      <div className="absolute inset-0 bg-white/80 backdrop-blur-sm flex items-center justify-center z-10">
                        <div className="text-center p-8">
                          ...
                          <p className="text-gray-500 mb-6 max-w-md">
                            Run the app to see a live preview.
                          </p>
                          {deploymentProgress && (
