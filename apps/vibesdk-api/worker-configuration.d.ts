/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (no --include-runtime false).
// Run `bun run cf-typegen` from apps/vibesdk-api/ to regenerate a fully self-contained file.
// The triple-slash reference below is a temporary bridge until then.
...
declare namespace Cloudflare {
  ...
  interface Env {
    ...
    CodeGenObject: DurableObjectNamespace<
      import('./src/index').CodeGeneratorAgent
    >;
    Sandbox: DurableObjectNamespace<
      import('./src/index').UserAppSandboxService
    >;
    DORateLimitStore: DurableObjectNamespace<
      import('./src/index').DORateLimitStore
    >;
    UserSecretsStore: DurableObjectNamespace<
      import('./src/index').UserSecretsStore
    >;
    ...
    // Service bindings to standalone Workers
    RATE_LIMIT: Fetcher;
    SECRETS_STORE: Fetcher;
  }
}
