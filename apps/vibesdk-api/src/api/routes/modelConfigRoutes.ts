...
export function setupModelConfigRoutes(app: Hono<AppEnv>): void {
  ...
  modelConfigRouter.get(
    ...
    adaptController(
      ...
      ModelConfigController.getModelConfigs,
    ),
  );
  modelConfigRouter.get(
    '/defaults',
  ...
  modelConfigRouter.get(
    ...
    adaptController(
      ModelConfigController,
      ModelConfigController.getByokProviders,
    ),
  );
  modelConfigRouter.get(
    '/:agentAction',
    ...
    adaptController(
      ModelConfigController,
      ModelConfigController.getModelConfig,
    ),
  );
  modelConfigRouter.put(
    ...
    adaptController(
      ModelConfigController,
      ModelConfigController.updateModelConfig,
    ),
  );
  modelConfigRouter.delete(
    ...
    adaptController(
      ModelConfigController,
      ModelConfigController.deleteModelConfig,
    ),
  );
  modelConfigRouter.post(
    ...
    adaptController(
      ModelConfigController,
      ModelConfigController.testModelConfig,
    ),
  );
  modelConfigRouter.post(
    '/reset-all',
    ...
    adaptController(
      ModelConfigController,
      ModelConfigController.resetAllConfigs,
    ),
  );
